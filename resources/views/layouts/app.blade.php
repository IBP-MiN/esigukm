...
<head>
    ...
    <!-- add icon link -->
    <link rel = "icon" href = "{{ asset('public/images/logo.jpg') }}" type = "image/x-icon">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <span>
                    <img src="{{ asset('public/images/logo.jpg') }}"  style="width: 40px; border-radius: 75px; border: 2px solid white;"></a>
                </span>
